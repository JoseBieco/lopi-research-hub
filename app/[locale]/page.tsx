...
export const metadata: Metadata = {
  ...
  description:
    "Centralizamos a produção acadêmica e as ferramentas do nosso grupo de pesquisa. Publicações, projetos, equipe e ferramentas.",
  keywords: [
    "pesquisa",
    "grupo de pesquisa",
    "publicações",
  ...
  openGraph: {
    title: "Plataforma Acadêmica | Grupo de Pesquisa",
    description:
      "Centralizamos a produção acadêmica e as ferramentas do nosso grupo de pesquisa",
    type: "website",
  },
};
    ...
    <main id="main-content" className="flex-1">
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8">{t("home.latest_news_description")}</p>
          <Link
            href="/news"
